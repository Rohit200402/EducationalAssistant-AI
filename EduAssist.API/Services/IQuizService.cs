...
{
    Task<QuizDetailDto> GenerateQuizAsync(string userId, int categoryId, string topic, int numberOfQuestions, string difficulty = "Medium");
    ...
    Task<PaginatedResponse<AdminQuizListDto>> GetAllQuizzesAsync(int pageNumber, int pageSize);
    Task<QuizStatsDto> GetQuizStatsAsync();
}
