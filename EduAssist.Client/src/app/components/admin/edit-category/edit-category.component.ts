...
export class EditCategoryComponent implements OnInit {
  ...
  ngOnInit(): void { this.categoryId = +this.route.snapshot.paramMap.get('id')!; this.categoryService.getById(this.categoryId).subscribe(c => this.subjectName = c.subjectName); }
  submit(): void {
    this.loading = true;
    this.categoryService.update(this.categoryId, { categoryId: this.categoryId, subjectName: this.subjectName }).subscribe({
